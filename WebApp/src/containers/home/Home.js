          ...
          <CardBody>
            ...
            <FormGroup>
              ...
              <h5 name="collegamento" id="collegamento">
                <a href={item.collegamento} target="_blank">
                  {item.collegamento} 🔗
                </a>
              </h5>
            </FormGroup>
...
const mapStateToProps = (state) => {
  return {
    stateSync: state.rootReducerStoreSync,
  };
};

export default raccoltaPerDestinazione = connect(mapStateToProps, {})(Home);
