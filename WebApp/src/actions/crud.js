...
export function postPerizia(body) {
  ...
  return callApi(baseURL + '/perizia', config, datiRequest, datiSuccess, datiFailure)
}
...
export function postPeriziaItem(body) {
  ...
  return callApi('/perizia', config, datiRequest, datiSuccessItem, datiFailure)
}
...
export function dati() {
  ...
  return callApi('/crud', config, datiRequest, datiSuccess, datiFailure)
}
